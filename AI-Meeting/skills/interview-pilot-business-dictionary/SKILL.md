---
name: interview-pilot-business-dictionary
...
# interview-pilot-business-dictionary
...
- 不要用我直接改面试状态机；那属于 `interview-pilot-interview-domain`。
- 不要用我直接改通用 Agent 聊天；那属于 `interview-pilot-agent-domain`。
- 不要用我直接改媒体协议；那属于 `interview-pilot-media-domain`。
- 不要用我直接调 Guard、限流或线程池；那属于 `interview-pilot-ai-runtime`。
