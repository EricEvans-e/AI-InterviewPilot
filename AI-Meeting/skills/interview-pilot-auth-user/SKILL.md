...
- `admin/src/main/java/com/interviewpilot/auth/infrastructure/satoken/SaTokenCurrentUserService.java`
- `admin/src/main/java/com/interviewpilot/auth/infrastructure/satoken/SaTokenLoginSessionService.java`
- `admin/src/main/java/com/interviewpilot/auth/infrastructure/websocket/SaTokenWebSocketAuthService.java`
- `admin/src/main/java/com/interviewpilot/auth/infrastructure/satoken/SaTokenPermissionService.java`
- `admin/src/main/java/com/interviewpilot/user/api/UserController.java`
