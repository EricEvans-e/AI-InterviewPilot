...
description: AI-Meeting 媒体与实时通信知识 Skill。用于处理实时语音转写、WebSocket 推送、心跳、错误通知、长文本 TTS 和消息协议；当需求命中 `/api/ip/v1/xunfei/**`、`/api/ip/v1/websocket/**` 或 `@ServerEndpoint` 实时链路时使用。
---
...
- `admin/src/main/java/com/hewei/hzyjy/interviewpilot/media/infrastructure/websocket/AudioTranscriptionWebSocketHandler.java`
- `admin/src/main/java/com/hewei/hzyjy/interviewpilot/media/infrastructure/integration/XunfeiAudioService.java`
- `admin/src/main/java/com/hewei/hzyjy/interviewpilot/media/infrastructure/integration/XunfeiLongTextTtsService.java`
