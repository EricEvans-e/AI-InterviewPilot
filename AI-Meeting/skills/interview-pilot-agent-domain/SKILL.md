---
name: interview-pilot-agent-domain
description: AI-Meeting 通用 Agent 业务知识 Skill。用于处理通用 Agent 会话创建、SSE 聊天、历史消息、会话归属、Agent 属性管理、文件上传与业务场景绑定；当需求命中 `/api/ip/v1/agents/**`、`/api/ip/v1/agent-properties/**` 或通用 Agent 会话行为时使用。
---
