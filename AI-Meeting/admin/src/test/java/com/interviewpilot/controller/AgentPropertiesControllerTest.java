...
import com.interviewpilot.agent.api.AgentPropertiesController;
...
class AgentPropertiesControllerTest {
    ...
    void testCreate() throws Exception {
        ...
        mockMvc.perform(post("/api/ip/v1/agent-properties")
    ...
    void testDelete() throws Exception {
        ...
        mockMvc.perform(delete("/api/ip/v1/agent-properties/{id}", id))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.code").value(0));
    }
    ...
    void testUpdate() throws Exception {
        ...
        mockMvc.perform(put("/api/ip/v1/agent-properties")
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(reqDTO)))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.code").value(0));
    ...
    void testGetByName() throws Exception {
        ...
        mockMvc.perform(get("/api/ip/v1/agent-properties/byName")
    ...
    void testGetByPage() throws Exception {
        ...
        mockMvc.perform(get("/api/ip/v1/agent-properties")
                .param("pageNum", "1")
                .param("pageSize", "10"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.code").value(0))
