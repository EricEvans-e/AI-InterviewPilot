...
class XunfeiAudioServiceTest {
    ...
    void setUp() {
        ...
        storageProperties.setBaseDir("target/interview-pilot-test");
        storageProperties.setAudioTempDir("target/interview-pilot-test/audio");
        storageProperties.setUploadTempDir("target/interview-pilot-test/upload");
        storageProperties.setLogDir("target/interview-pilot-test/logs");
