...
import com.interviewpilot.toolkit.Threads;
...
public class ThreadPoolConfig {
    ...
    protected ScheduledExecutorService scheduledExecutorService() {
        ...
        String prefix = normalizePrefix(properties.getScheduledThreadNamePrefix(), "ip-schedule-");
    ...
    private ThreadPoolTaskExecutor buildTaskExecutor(ApplicationThreadPoolProperties.Pool pool) {
        ...
        executor.setThreadNamePrefix(normalizePrefix(pool == null ? null : pool.getThreadNamePrefix(), "ip-async-"));
    ...
    private ExecutorService buildExecutorService(String poolName, ApplicationThreadPoolProperties.Pool pool) {
        ...
        String prefix = normalizePrefix(pool == null ? null : pool.getThreadNamePrefix(), "ip-exec-");
