package com.interviewpilot.common.biz.message;
...
import com.interviewpilot.ai.dao.entity.AiMessage;
import com.interviewpilot.ai.dao.repository.AiMessageRepository;
...
public class MessageSequenceAllocator {
    ...
    private static final String AGENT_SEQ_KEY_PREFIX = "interview-pilot:msg-seq:agent:";
    private static final String AI_SEQ_KEY_PREFIX = "interview-pilot:msg-seq:ai:";
