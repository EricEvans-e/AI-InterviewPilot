...
import com.interviewpilot.interview.config.InterviewTurnRepairConfiguration;
...
public class InterviewTurnRepairService {
    ...
    @Scheduled(fixedDelayString = "${interview-pilot.interview.turn-repair.fixed-delay-millis:3000}")
