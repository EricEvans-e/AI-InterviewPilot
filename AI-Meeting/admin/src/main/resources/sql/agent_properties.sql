...
ALTER TABLE agent_properties ADD COLUMN ai_provider VARCHAR(50) DEFAULT 'xingchen' COMMENT 'AI 提供商: xingchen, mimo';
...
-- Mimo Agent（ai_provider = mimo, field reuse: api_secret=模型名, api_flow_id=API URL）
...
('Mimo面试评分官', 'mimo-v2.5-pro', 'tp-s7h68tp5edc1zh2co9cw7n9oeakrkwp7fcwwajwom0rdo7wt', 'https://token-plan-sgp.xiaomimimo.com/anthropic', 'mimo', 0, NOW(), NOW()),
('Mimo面试提问官', 'mimo-v2.5-pro', 'tp-s7h68tp5edc1zh2co9cw7n9oeakrkwp7fcwwajwom0rdo7wt', 'https://token-plan-sgp.xiaomimimo.com/anthropic', 'mimo', 0, NOW(), NOW()),
('Mimo面试出题官', 'mimo-v2.5-pro', 'tp-s7h68tp5edc1zh2co9cw7n9oeakrkwp7fcwwajwom0rdo7wt', 'https://token-plan-sgp.xiaomimimo.com/anthropic', 'mimo', 0, NOW(), NOW()),
('Mimo神态分析官', 'mimo-v2.5-pro', 'tp-s7h68tp5edc1zh2co9cw7n9oeakrkwp7fcwwajwom0rdo7wt', 'https://token-plan-sgp.xiaomimimo.com/anthropic', 'mimo', 0, NOW(), NOW());
