...
export function buildInterviewReportViewModel(
  ...
  const radarChartObj = toRecord(record?.radarChart) ?? null;

  const dimensionScores: DimensionScores = {
    contentScore: pickFirstNumber(
      radarChartObj?.contentScore,
      rawRecord?.contentScore,
      snapshot?.contentScore,
    ),
    logicScore: pickFirstNumber(
      radarChartObj?.logicScore,
      rawRecord?.logicScore,
      snapshot?.logicScore,
    ),
    professionalScore: pickFirstNumber(
      radarChartObj?.professionalScore,
      rawRecord?.professionalScore,
      snapshot?.professionalScore,
    ),
    expressionScore: pickFirstNumber(
      radarChartObj?.expressionScore,
      rawRecord?.expressionScore,
      snapshot?.expressionScore,
    ),
    adaptabilityScore: pickFirstNumber(
      radarChartObj?.adaptabilityScore,
      rawRecord?.adaptabilityScore,
      snapshot?.adaptabilityScore,
    ),
    timeControlScore: pickFirstNumber(
      radarChartObj?.timeControlScore,
      rawRecord?.timeControlScore,
      snapshot?.timeControlScore,
    ),
    etiquetteScore: pickFirstNumber(
      radarChartObj?.etiquetteScore,
      rawRecord?.etiquetteScore,
      snapshot?.etiquetteScore,
    ),
  };
