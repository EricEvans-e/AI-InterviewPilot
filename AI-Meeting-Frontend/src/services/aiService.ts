...
export const aiService = {
  getAiProperties: (params?: GetAiPropertiesParams) => {
    return service.get<AiPropertiesPageResult>("/ip/v1/ai-properties", {
      params: {
        ...params,
        size: 100,
      },
  ...
  streamChat: async (
    ...
    const url = buildApiUrl(
      `/ip/v1/ai/sessions/${encodeURIComponent(sessionId)}/chat`,
      {
        username: userName,
      },
    );
